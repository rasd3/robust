...
backend_args = None
out_size_factor = 8
pillar_size = [0.075*out_size_factor, 0.075*out_size_factor, point_cloud_range[5]-point_cloud_range[2]]
model = dict(
    type='BEVFusion',
    freeze_img=True,
    ...
    masking_encoder=dict(
        type='DeepInteractionEncoderMask',
        mask_ratio=0.5,
        embed_dim=256,
        pos_embed=True
    ),
...
#load_from = 'work_dirs/CA_residual_freeze_img_pers/epoch_5.pth'
