...
launcher = 'pytorch'
load_from = 'work_dirs/CA_residual_freeze_img_layer2/epoch_5.pth'
log_level = 'INFO'
...
model = dict(
    ...
    fusion_layer=dict(
        ...
        num_layers=2,
        out_channels=256,
        type='ModalitySpecificLocalCrossAttentionMask'),
    img_backbone=dict(
        attn_drop_rate=0.0,
    ...
    pts_backbone=dict(
        ...
        norm_cfg=dict(eps=0.001, momentum=0.01, type='SyncBN'),
        out_channels=[
            128,
            256,
        ],
