work_dir=work_dirs/masking_strategy/version1/mask_l_defaultm_deform_attn_2_ca
...
do
    bash tools/dist_test.sh projects/BEVFusion/configs/deform_cross_failure/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d_$failures.py $work_dir/epoch_5.pth 4 --work-dir $work_dir/$failures
done