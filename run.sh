#bash tools/dist_train.sh projects/BEVFusion/configs/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d_CA_mask.py 4 --work-dir work_dirs/masking_strategy/version1/mask_lc_defaultm_deef_2lay
...
for failures in 'object_failure' 'camera_stuck' 'camera_view_drop' 'lidar_stuck' 'limited_fov' 'spatial_misalignment' 'lidar_drop' 'occlusion'
do
    bash tools/dist_test.sh projects/BEVFusion/configs/failure/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d_$failures.py checkpoint/bevfusion_reproduced_freeze_img_715.pth 1 --work-dir work_dirs/bevfusion_reproduced_freeze_img_715/$failures
